...
module.exports = {
    ...
    async run(client, role) {
        ...
        guild.roles.edit(role.role.id, {
            ...role.role,
            reason: "ShieldDefender - Anti-RoleUpdate"
        })

        client.util.punish(guild, executorMember, config.punish, "ShieldDefender - Anti-RoleUpdate", await client.lang('antiraid.roleupdate.err', message.guild.id), await client.lang('antiraid.roleupdate.succes', message.guild.id))
    }
}